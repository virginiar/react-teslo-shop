...
export const AdminProductPage = () => {
  ...
  const [product, setProduct] = useState<Product>({
    ...
    price: 115,
    description:
      "Presentamos la colección Tesla Raven. La sudadera con capucha ligera Raven para hombre tiene un corte holgado de alta calidad y está confeccionada con una mezcla sostenible de algodón y bambú. La sudadera cuenta con discretos logotipos de Tesla de poliuretano termoplástico en el pecho y en la manga, y un interior de felpa francesa que la hace versátil para cualquier estación del año. Confeccionada con un 70 % de bambú y un 30 % de algodón.",
    slug: "men_raven_lightweight_hoodie",
    stock: 10,
    sizes: ["XS", "S", "M", "L", "XL", "XXL"],
    gender: "men",
    tags: ["sudadera"],
    images: [whiteHoodie, whiteHoodie, whiteHoodie, whiteHoodie],
  });
